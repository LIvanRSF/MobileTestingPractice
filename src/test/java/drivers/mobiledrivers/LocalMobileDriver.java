...
import config.mobile.localdevice.LocalMobileConfig;
...
public class LocalMobileDriver implements WebDriverProvider {
    static final LocalMobileConfig config =
        ConfigFactory.create(LocalMobileConfig.class, System.getProperties());
    ...
    public WebDriver createDriver(Capabilities capabilities) {
        ...
        options.setDeviceName(config.virtualDeviceName());
        options.setPlatformVersion(config.virtualDevicePlatformVersion());
